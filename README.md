...
# installation: 
```
kubectl apply -f https://raw.githubusercontent.com/jodevsa/wireguard-operator/0.0.2/release.yaml
```
...
# uninstall
```
kubectl delete -f https://raw.githubusercontent.com/jodevsa/wireguard-operator/0.0.2/release.yaml
```
